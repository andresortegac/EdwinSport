...
<script>
    function goToEvento(element) {
        ...
        // Si el panel define carga embebida, abre la competencia dentro del contenido.
        if (window.__embedCompetitionInPanel && typeof window.openCompeticionInPanel === 'function') {
            window.openCompeticionInPanel(url);
            return;
        }
