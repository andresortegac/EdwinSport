...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@400;500;600&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('CSS/views/register/participantes.css') }}">
...
<div class="container py-5">
  <div class="pro-card">
    ...
    {{-- MENSAJES DE EXITO (equipos y participantes) --}}
    @if(session('success'))
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
      <div>
        <h1 class="mb-1" style="font-family: Oswald;">Crear / Editar Equipo</h1>
        <p class="muted mb-0">Registra el equipo primero, luego agrega jugadores.</p>
      </div>

      {{-- ESTE boton vuelve al register
    ...
    <form method="POST"
      ...
      <div class="col-md-6">
        <label class="form-label">Telefono (Equipo) *</label>
      ...
      <div class="col-md-3">
        <label class="form-label">Valor de inscripcion *</label>
              ...
              <tr>
                ...
                <td class="text-end d-flex gap-2 justify-content-end">
                  ...
                  <form action="{{ route('equipos.destroy', $e->id) }}"
                        method="POST"
                        data-confirm-delete="¿Eliminar equipo?">
                    @csrf
                    @method('DELETE')
              ...
              <tr>
                ...
                <td class="text-end d-flex gap-2 justify-content-end">
                  ...
                  <form action="{{ route('participantes.destroy', $p->id) }}"
                        method="POST"
                        data-confirm-delete="¿Eliminar jugador?">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-sm btn-danger">Eliminar</button>
                  </form>
    ...
    @else
      <p class="muted">Aun no hay jugadores registrados.</p>
    @endif
...
<script src="{{ asset('js/views/register/participantes.js') }}"></script>
</body>
</html>
